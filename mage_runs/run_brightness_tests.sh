...
# ============================================================
# Run Brightness experiments for MAGE models
# Usage:
#   ./run_brightness_tests.sh <VAL_LABELS> <TEST_LABELS> <OUTPUT_DIR> <TRIAL_ID> <MODES>
#
# Example:
#   ./run_brightness_tests.sh \
...
# Brightness noise intensity levels
BRIGHTNESS_LEVELS=("-30" "-20" "-15" "-10" "-5" "-1" "" "1" "5" "10" "15" "20" "30")

MODEL_EXPS=("EXP_1__13" "EXP_1__21" "EXP_1__20" "EXP_1__15" "EXP_1__14")

# Print configuration
echo "============================================================"
echo " Running Brightness tests with parameters:"
