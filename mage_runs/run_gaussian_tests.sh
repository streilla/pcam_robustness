...
# ============================================================
# Run Gaussian experiments for MAGE models
# Usage:
#   ./run_gaussian_tests.sh <VAL_LABELS> <TEST_LABELS> <OUTPUT_DIR> <TRIAL_ID> <MODES>
#
# Example:
#   ./run_gaussian_tests.sh \
...
# Gaussian noise intensity levels
GAUSSIAN_LEVELS=("");
...
# Print configuration
echo "============================================================"
echo " Running Gaussian tests with parameters:"
