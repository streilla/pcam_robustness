...
# ============================================================
# Run Poisson experiments for MAGE models
# Usage:
#   ./run_poisson_tests.sh <VAL_LABELS> <TEST_LABELS> <OUTPUT_DIR> <TRIAL_ID> <MODES>
#
# Example:
#   ./run_poisson_tests.sh \
...
# # Poisson noise intensity levels
POISSON_LEVELS=("" "2000" "1000" "500" "255" "100" "80" "60" "40" "20" "10")

MODEL_EXPS=("EXP_1__13" "EXP_1__21" "EXP_1__20" "EXP_1__15" "EXP_1__14")

# Print configuration
echo "============================================================"
echo " Running Poisson tests with parameters:"
